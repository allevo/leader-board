...
export default class LeaderBoardService {
  private readonly mongoCollection: Db
  private readonly api: OgyreRepo
  ...
  async importData (log: FastifyBaseLogger): Promise<void> {
  ...
  async createLeaderBoard (log: FastifyBaseLogger): Promise<void> {
